...
args_json="configs/gpt2_scratch_neuro_tokenizer_bayes_fwd_mini.json"
...
accelerate launch --config_file accel_config.yaml train_bayes_with_resume_experimental.py $key_value_pairs




# # Define the JSON file and expdir
# args_json="configs/gpt2_scratch_neuro_tokenizer_bayes_rev.json"
